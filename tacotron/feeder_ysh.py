...
class Feeder:
	...
	def __init__(self, coordinator, metadata_filename, hparams):
		...
		test_size = (hparams.tacotron_test_size if hparams.tacotron_test_size is not None
			else hparams.tacotron_test_batches * hparams.tacotron_test_batch_size)
		...
		len_test_indices = self._round_down(len(test_indices), hparams.tacotron_test_batch_size)
		...
		self.test_steps = len(self._test_meta) // hparams.tacotron_test_batch_size
	...
	def make_test_batches(self):
		...
		n = self._hparams.tacotron_test_batch_size
